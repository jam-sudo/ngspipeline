...
- Active task: T-40 agent part done (DoD re-verified on dev tip, docs/evidence/T-40_*); T-42 done (docs/05). T-30 done on Discovery 2026-09-16 (F7 2/3); v1.0 waits for T-03/T-05/T-31 and F9 — see docs/progress.md "Remaining for v1.0"
